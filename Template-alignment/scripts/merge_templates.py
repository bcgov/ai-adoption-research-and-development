...
def merge_templates(polygonal_file: Path, rectangular_file: Path, output_file: Path):
    """Merge polygonal and rectangular template data into a single JSON file."""
...
if __name__ == "__main__":
    polygonal_file = BASE_DIR / "data/templates/template_polygonal.json"
    rectangular_file = BASE_DIR / "data/templates/template_rectangular.csv"
    output_file = BASE_DIR / "data/templates/template.json"
